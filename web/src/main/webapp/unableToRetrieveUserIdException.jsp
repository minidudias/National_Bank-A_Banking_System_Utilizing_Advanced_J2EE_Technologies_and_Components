...
<head>
  ...
  <title>Unable to Retrieve the User ID - National Bank</title>
  <style>
    .error-container {
      height: 100vh;
      display: flex;
...
<div class="error-container">
  ...
  <h2 class="error-message">Unable to Retrieve the User ID</h2>
...
<script>
  setTimeout(function() {
    window.location.href = "${pageContext.request.contextPath}/officer";
  }, 3000);
</script>
</body>
</html>